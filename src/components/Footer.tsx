  ...
  return (
    <footer className="mt-24">
      ...
      <div className="bg-[var(--color-surface-cream-strong)]">
        <div className="mx-auto flex max-w-[1200px] flex-col items-start gap-6 px-6 py-14 md:flex-row md:items-center md:justify-between md:px-10 md:py-16">
          ...
          <p className="max-w-[36ch] text-sm leading-relaxed text-[var(--color-body)]">
            Taller diseñado para alumnos de carreras de negocios. Uso académico
            interno.
          </p>
        </div>
      </div>
